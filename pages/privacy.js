...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <Text p="20" color='white' textAlign="justify">
        ...
        Device Information using the following technologies: - “Cookies” are
        data files that are placed on your device or computer and often include
        an anonymous unique identifier. For more information about cookies, and
        how to disable cookies, visit http://www.allaboutcookies.org. - “Log
        files” track actions occurring on the Site, and collect data including
        ...
        Site. We share your Personal Information with third parties to help us
        use your Personal Information, as described above. We also use Google
        ...
        http://optout.aboutads.info/. Please note that we do not alter our
        Site’s data collection and use practices when we see a Do Not Track
        signal from your browser. If you are a European resident, you have the
        right to access personal information we hold about you and to ask that
        your personal information be corrected, updated, or deleted. If you
        ...
        might have with you or otherwise to pursue our legitimate business
        ...
        United States. The Site is not intended for individuals under the age of
        18. We may update this privacy policy from time to time in order to
        ...
        <a href="mailto:garridoj84@gmail.com"> garridoj84@gmail.com</a> or by
        mail using the details provided below: Accra , Greater Accra, Ghana
      </Text>
    </>
  );
};
