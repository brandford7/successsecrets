...
const NavBarThree = () => {
  ...
  return (
    <>
      <Stack direction={["column", "column", "row"]} spacing="3" p="10">
        <Link href="/" passHref>
          <DateCard day={moment(today).subtract(3, "days").format("dddd")}>
            {moment(today).subtract(3, "days").format("Do MMMM")}
          </DateCard>
        </Link>
        <Link href="/" passHref>
          <DateCard day={moment(today).subtract(2, "days").format("dddd")}>
