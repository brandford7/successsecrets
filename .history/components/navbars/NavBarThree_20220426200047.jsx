...
const NavBarThree = () => {
  const dates = [
      ...
      todayDate format(new Date(), "do MMMM"),
    tday: format(new Date(), "EEEE") },
  tomorrow:{ date: format(addDays(new Date(), 1), "do MMMM") ,
day: format(addDays(new Date(), 1), "EEEE") },
     
  yesterday:{ date: format(subDays(new Date(), 1), "do MMMM"),
