...
const Forms = () => {
  const values = { country: "Enlgand", odd: "", match: "", bet: "" };
    ...
    <>
      ...
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          image_url: Yup.string().max(1000, "Must be a number").required("Required"),
        })}
        ...
        {(formik) => (
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl isInvalid={formik.errors.image_url && formik.touched.image_url}>
              <FormLabel htmlFor="odd">image</FormLabel>
              <Input id="image" type="text" {...formik.getFieldProps("odd")} />
