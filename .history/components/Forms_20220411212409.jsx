      ...
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          match: Yup.string()
            ...
            .required("Required"),
          odd: Yup.number("Must be a number")
            .max(1000, "Number is too big")
            .required("Required"),
          image_url: Yup.string()
            .max(1000, "Must be a string")
            .required("Required"),
          result:Yup.string().max(10, "Must be 10 characters or less").required('Required')
        })}
        ...
        {(formik) => (
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl
              isInvalid={formik.errors.image_url && formik.touched.image_url}
            >
              <FormLabel htmlFor="image">Result</FormLabel>
              <Input
                id="result"
                type="text"
